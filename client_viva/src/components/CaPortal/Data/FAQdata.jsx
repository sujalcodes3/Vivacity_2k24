const FAQdata = [
  {
    ...
    content:
      'Campus Ambassador will represent Vivacity, LNMIIT in their colleges. They will be the first point of contact to any student who requires information about Vivacity. They would promote and motivate students to participate in the events conducted by Vivacity.',
  },
  {
  ...
  {
    title:
      'How many Campous Ambassadors are usually chosen from one particular college?',
    content:
  ...
  {
    title:
      'How much time do I need to devote to Vivacity, LNMIIT once selected as a Campous Ambassador?',
    content:
