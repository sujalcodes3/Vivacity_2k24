const InputSelect = ({text,options,handler,valu}) => {
    return ( 
        <div className="normal-select w-5/6 mx-auto flex flex-col gap-3">
            ...
            <select onChange={handler} value={valu} className="text-white cursor-pointer py-1 px-4 md:py-3 md:px-6 rounded-[8px] border border-[#4A3FAD]">
