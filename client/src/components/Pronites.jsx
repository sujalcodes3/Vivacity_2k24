...
const Pronites = () => {
    ...
    return (
        <>
            ...
            <div
                className=" w-full relative min-h-screen bg-cover bg-no-repeat bg-center p-0 m-0 flex flex-col items-center justify-center"
            ...
            >
                <div className="w-fit mx-auto flex flex-wrap justify-center gap-16 mb-14">
                    ...
                    <ProniteCard
                        ...
                        color="#FF6B00"
                    />
                    <ProniteCard name={'To Be Announced...'} date={'10 Feb'} />
                    <ProniteCard
                        name={'To Be Announced...'}
                        date={'10 Feb'}
                        color="#FFF500"
                ...
                <div className="w-fit mx-auto flex flex-wrap justify-center gap-16 mb-20">
                    ...
                    <ProniteCard
                        ...
                        color="#FF6B00"
                    />
                    <ProniteCard name={'To Be Announced...'} date={'11 Feb'} />
                    <ProniteCard
                        name={'To Be Announced...'}
                        date={'11 Feb'}
                        color="#FF6B00"
                ...
                <img
                    src={StarL}
                    alt="star"
                    className="absolute lg:block hidden w-[41px] bottom-56 left-28"
                />
                <img
                    src={StarL}
                    alt="star"
                    className="absolute lg:block hidden w-[20.5px] bottom-32 right-[22%]"
                />

                <div
                    className={` absolute bottom-4 flex flex-col transition-all duration-400 right-0 z-50 items-end ${
                ...
                >
                    <img
                        src={favart}
                        alt="dialog"
                        className="lg:w-[300px] w-[150px] relative left-0"
                    />
                    <img
                        src={char}
                        alt="character"
