...
const Sponsor = () => {
    ...
    return ( 
        <>  
            <div className='min-h-screen lg:h-screen snap-start relative flex items-center justify-center bg-cover bg-no-repeat bg-center' style={{backgroundImage:'url('+Background+')'}}>
